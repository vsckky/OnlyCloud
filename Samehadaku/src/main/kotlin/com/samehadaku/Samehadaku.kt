...
class Samehadaku : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "daftar-anime-2/?title=&status=&type=&order=title&page" to "Daftar Lengkap",
        ...
        "daftar-anime-2/?title=&status=&type=&order=title&genre=comedy &page=" to "Comedy",
        "daftar-anime-2/?title=&status=&type=&order=title&genre=drama&page=" to "Drama",
